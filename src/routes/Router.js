...
/* ****Pages***** */
const Dashboard1 = Loadable(lazy(() => import('../views/dashboards/Index')));
...
const Router = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', exact: true, element: <Navigate to="/auth/login" replace /> }, // Redirecciona a login
      { path: '/dashboards/index', exact: true, element: <Dashboard1 /> },
